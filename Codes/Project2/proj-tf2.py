...
seed(1)
tf.random.set_seed(1)# set_random_seed is no longer exist in Tensorflow 2.1
...
train_x_location = foldersmall + "/" + "x_train_8_10.csv"
train_y_location = foldersmall + "/" + "y_train_8_10.csv"
...
model = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Conv2D(33, (3,3), padding='same', activation=tf.nn.relu),
    tf.keras.layers.Conv2D(68, (3,3), padding='same', activation=tf.nn.relu),
